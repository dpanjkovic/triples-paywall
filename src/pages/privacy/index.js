    ...
    { !vars.imgsLoaded ?
      ...
      <div className="flex justify-center container">
        ...
        <div className="content body noanim animbottom" dir={ lang === "AR" ? "RTL" : "" }>
          ...
          <h3 id="data" className="noanim animbottom">What data we collect</h3>
          ...
          <h3 id="information" className="noanim animbottom">Use of Your Personal information</h3>
          <div className="noanim animbottom">
          ...
          <h3 id="disclosure" className="noanim animbottom">Disclosure of Your Personal information</h3>
          <div className="noanim animbottom">
          ...
          <h3 id="thirdparty" className="noanim animbottom">Third Party Websites</h3>
          <div className="noanim animbottom">
          ...
          <h3 id="youngpeople" className="noanim animbottom">Young People</h3>
          <div className="noanim animbottom">
          ...
          <h3 id="rights" className="noanim animbottom">Your Rights</h3>
          <div className="noanim animbottom">
